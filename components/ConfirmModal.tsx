...
export default function ConfirmModal(props: ConfirmModalProps): React.ReactElement {
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            <button type="button" className="btn btn-warning" onClick={confirmCallBack}>
              Kyllä
            </button>
            <button type="button" className="btn btn-secondary" onClick={onCloseCallBack}>
              Peruuta
            </button>
          </div>
        </div>
