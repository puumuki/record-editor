...
export default function Header(): React.ReactElement {
  const handleSignin = async (event: MouseEvent): Promise<void> => {
    await signIn()
  }

  const handleSignout = async (event: MouseEvent): Promise<void> => {
    await signOut()
  }
    ...
    <header className="navigation">
      <div className="container d-flex flex-wrap">
        <Link href="/" className="logo">
          <Image src="/logo-v1.svg" alt="logo" height="40" width="150"></Image>
        </Link>
