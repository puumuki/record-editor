...
import {unixTimeToLocalTime, dateTimeSeparated, dateTimeSeparatedToUnixTime, DateTimeParts} from '../lib/date-helper';
...
describe('Convert seconds to minutes, seconds and hurdreds of second.', () => {
  ...
  it("dateTimeSeparatedToUnixTime({ date: '2022-11-04', time: '08:36' })", () => {      
    const separatedTime = { date: '2022-11-04', time: '08:36' };    
    ...
    expect( result  ).toEqual(1667543760000);
  ...
  it("Convert unix time to localtime", () => {
    const result = unixTimeToLocalTime(1667543760000);
    expect( result ).toEqual('2022-11-04 08:36');    
  });
